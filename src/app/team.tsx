    ...
    <div className="relative bg-[#32bb78]">
      ...
      <div className="relative mx-auto max-w-7xl py-24 sm:py-32 lg:px-8 lg:py-40">
        <div className="pl-6 pr-6 md:ml-auto md:w-2/3 md:pl-16 lg:w-1/2 lg:pl-24 lg:pr-0 xl:pl-32">
          <h2 className="text-base/7 font-semibold text-white">Support primé</h2>
          <p className="mt-2 text-4xl font-semibold tracking-tight text-white sm:text-5xl">Nous sommes là pour vous aider</p>
