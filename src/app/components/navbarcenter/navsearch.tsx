...
export default function Navsearch() {
  ...
  const topics = {
    ...
    "Assurance": [
      ...
      { question: "Que faire si j’ai un accident et que je ne sais pas comment procéder ?", answer: "Contactez immédiatement notre support pour obtenir des instructions." },
    ...
    <section className="bg-gray-50 py-12">
      <div className="max-w-screen-xl px-6 mx-auto sm:px-12 lg:px-16">
        <div className="max-w-screen-md mx-auto text-center mb-12">
          <h2 className="text-3xl font-extrabold text-gray-800">Comment pouvons-nous vous aider ?</h2>
          <p className="text-lg text-gray-600 mt-4">Trouvez des réponses à vos questions ci-dessous ou utilisez la barre de recherche pour affiner votre recherche.</p>
          <div className="mt-6 relative">
            <input
              ...
              placeholder="Tapez des mots-clés pour trouver des réponses"
              value={searchTerm}
                ...
                {questions.map((q, index) => (
                  <li key={index}>
                    ...
                    {activeQuestion === q.question && (
                      <p className="mt-2 text-gray-700 text-base">{q.answer}</p>
                    )}
                  </li>
                ))}
              </ul>
