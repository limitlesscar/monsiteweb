  ...
  <div className="px-6 py-24 sm:px-6 sm:py-52 lg:px-8">
    <div className="mx-auto max-w-2xl text-center">
      ...
      <h2 className="text-white text-4xl font-semibold tracking-tight sm:text-5xl">
        <span className="typewriter">Location de voitures</span>
      </h2>
      
      {/* Description */}
      <p className="mx-auto mt-6 max-w-xl text-lg text-white">
        limitless est une application de location de voitures. Toutes nos voitures sont soigneusement vérifiées. Louez facilement une voiture via notre système de carte et trouvez-en une près de chez vous.
      </p>
      ...
      <div className="flex justify-center mt-4">
        ...
        <span className="text-white text-sm">(10k avis sur les stores)</span>
      </div>
    </div>
  </div>
</div>
